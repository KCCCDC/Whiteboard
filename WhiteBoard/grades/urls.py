...
urlpatterns = patterns(
    ...
    url(r'^create_assignment', views.CreateAssignmentView.as_view(),
        name='create_assignment'),
    url(r'^submit_assignment', views.submit_assignment,
    ...
    url(r'^view_examsubmissions', views.view_examsubmissions,
        name='view_examsubmissions'),
    url(r'^grade_examsubmission', views.grade_examsubmissions,
        name='grade_examsubmissions'),
